  ...
  return (
    <header className="h-11 sm:h-12 bg-background border-b border-border flex items-center justify-between px-3 sm:px-4 shrink-0 min-w-0">
      ...
      <div className="flex items-center gap-2 sm:gap-4 min-w-0">
        <Link to="/" className="flex flex-col justify-center hover:opacity-90 transition-opacity shrink-0">
          <h1 className="text-sm sm:text-base font-semibold tracking-tight text-foreground">AxonAI</h1>
          <span className="text-[9px] sm:text-[10px] text-text-muted -mt-0.5 hidden md:inline">
            Organizational Intelligence Layer
          </span>
        </Link>
        <Link
          to="/critic"
          className="text-[10px] sm:text-[11px] text-text-tertiary hover:text-primary transition-default px-2 py-1.5 border border-border hover:border-primary/50 shrink-0"
        >
          Critic Agent
        </Link>
      </div>
